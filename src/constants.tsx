...
// URL Web App Terbaru (AKfycbwnKRWSSGHiBmIkIsMTYiiCrdgvYgylt1ViDSk0xlPhclgNS_j_cCf8rG1IPikK3r7O)
// INI ADALAH KUNCI UTAMA KONEKSI KE DATABASE BARU
export const DEFAULT_GAS_URL = 'https://script.google.com/macros/s/AKfycbwnKRWSSGHiBmIkIsMTYiiCrdgvYgylt1ViDSk0xlPhclgNS_j_cCf8rG1IPikK3r7O/exec';
...
export const DEFAULT_SETTINGS: PhotoboothSettings = {
  ...
  originalFolderId: '', 
  // ID Spreadsheet Baru
  spreadsheetId: '1LzgzSxHKGYf0nnSKqIuXnf9Lk8DC1Yoqmd8fW2JvGzc', 
  ...
  videoModel: 'seedance-1-0-pro-fast-251015', 
  boothMode: 'video', 
  monitorImageSize: 'medium',
  monitorTheme: 'physics', 
